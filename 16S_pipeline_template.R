### This is a modifiable template for exploring and testing differential abundance between groups of samples 
### using 16S amplicon sequencing data. In this example, we explore differences in the stool microbiota of mice 
### sourced from different vendors prior to intervention (Day -6). 
...
## Subset samples as appropriate. Here, all of Day == -6 and Source == Charles | Taconic
...
## Unifrac (consider Bray Curtis as well)
UD <- UniFrac(example)
